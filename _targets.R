...
list(
  ...
  tar_target(nwis_inventory,
             oldest_active_sites %>%
               ...
               tar_group(),
             iteration = "group"),
  tar_target(nwis_data,retry(expr = get_site_data(nwis_inventory,nwis_inventory$state_cd,parameter),
  ...
  tar_target(
    data_coverage_png,
    plot_data_coverage(tally,"3_visualize/out/data_coverage.png",parameter="00060"),
    format = "file"
  ),
